...
static uint8_t PhysFrameBuffer[SSD1315_LCD_COLUMN_NUMBER*SSD1315_LCD_PAGE_NUMBER];
...
void ssd1315_Init(void)
{
    ...
    MenuInit(PhysFrameBuffer, ssd1315_refresh);
}
...
void LCD_IO_WriteCommand(uint8_t Cmd)
{
	  ...
	  I2C_Send7bitAddress( SSD1315_ADDR, I2C_Direction_Transmitter );
